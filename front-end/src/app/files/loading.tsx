      ...
      <div className="text-center">
        <div className="relative">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            <File className="h-6 w-6 text-green-800" />
          </div>
        </div>
        <h2 className="text-xl font-bold text-gray-800 mb-2">Loading Files</h2>
        <p className="text-md text-gray-600">Accessing your documents...</p>
